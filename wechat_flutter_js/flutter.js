...
(function () {
  ...
  console.log("[MPF-BOOT] flutter.js init done", JSON.stringify({
    ...
    selfError: typeof self !== "undefined" ? typeof self.Error : "no-self",
    selfPromise: typeof self !== "undefined" ? typeof self.Promise : "no-self",
...
(function () {
  ...
  (function () {
    ...
    console.log("[MPF-BOOT] _flutter.self patched", JSON.stringify({
      error: typeof g.Error,
      symbol: typeof g.Symbol,
      parseFloat: typeof g.parseFloat,
